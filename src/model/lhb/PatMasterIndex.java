...
public class PatMasterIndex implements java.io.Serializable
{
   ...
   public PatMasterIndex(String patientId, String inpNo, String name,
         ...
         String nowZipCode, String zgBh, String zgZzFlag, String gfDwdm,
         String mailingStreetCode, String parentName, String parentPatientId,
         String patName2, Double tz, String mailingAddrAreaCode,
         String mailingAddrStreetNo, String regResidenceAreaCode,
   ...
   public Timestamp getNextOfBath()
   {
      return this.nextOfBath;
   }

   public void setNextOfBath(Timestamp nextOfBath)
   {
      this.nextOfBath = nextOfBath;
   }
