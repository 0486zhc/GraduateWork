                ...
                <ul>
                    ...
                    <li>
                        <div class="dc_info">
                            <dl>
                                <dt>
                                    <a href="OzqActionOnDuty.action?doctor_name=廖志坚" class="dc_info_pic fl block o-hidden"><img src="images/doctor.jpg" width="72" height="auto"  alt=""></a>
                                    <a href="OzqActionOnDuty.action?doctor_name=廖志坚" class="dc_info_name fl fs18">廖志坚</a>
                                    <span class="dc_info_pst fl fs12">副主任医师</span>
                                </dt>
                                <dd>
                                    <div class="dc_info_hs">
                        ...
                        <div class="dc_icon">
                            <a href="OzqActionOnDuty.action?doctor_name=廖志坚"><i></i>预约挂号</a>
                        </div>
                    </li>
                    <li>
                        <div class="dc_info">
