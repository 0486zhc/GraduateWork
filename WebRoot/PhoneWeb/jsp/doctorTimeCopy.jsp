			...
			<div class="orderdata ">
				<div class="od_tt">
					...
					<div class="timetable fl">
						<ul>
							<li class="fl">06-11<br>周三</li>
							<li class="fl">06-12<br>周四</li>
							<li class="fl">06-13<br>周五</li>
							<li class="fl holiday">06-14<br>周六</li>
							<li class="fl holiday">06-15<br>周日</li>
							<li class="fl">06-16<br>周一</li>
							<li class="fl">06-17<br>周二</li>
						</ul>
					</div>
				</div>
				<div class="od_cnt">
					<ul>
						<li class="beforenoon od_cnt_time clearfix">
							...
							class="fl t_c block fs12 od_btn order_off">约满</a> <a
							href="javascript:void(0);"
							class="fl t_c block fs12 od_btn order_null"></a> <a
							href="javascript:void(0);"
							class="fl t_c block fs12 od_btn order_null"></a> <a
							href="javascript:void(0);"
							class="fl t_c block fs12 od_btn order_null"></a> <a
							...
							class="fl t_c block fs12 od_btn order_null"></a> <a
							href="javascript:void(0);"
							class="fl t_c block fs12 od_btn order_access">预约<br>(16/21)</a>
						</li>
						<li class="afternoon od_cnt_time clearfix">
							...
							class="fl t_c block fs12 od_btn order_out">已过期</a> <a
							href="javascript:void(0);"
							class="fl t_c block fs12 od_btn order_null"></a> <a
							href="javascript:void(0);"
							class="fl t_c block fs12 od_btn order_null"></a> <a
							...
							class="fl t_c block fs12 od_btn order_null"></a></li>
						<li class="beforenoon od_cnt_time clearfix">
							<div class="fl">
								上<br>午
							</div>
...
<!-- 			<div class="bar_middle fl"> -->
<!-- 				（ 今日 <strong>18:00</strong> 开始可预约至<strong> 06 月 19 日</strong>号源，<strong>16:00</strong> -->
<!-- 				截止<strong> 06 月 12 日</strong>号源的预约 ） -->
<!-- 			</div> -->
<!-- end ===== -->
<!-- 		</ul> -->
<!-- 	</div> -->
