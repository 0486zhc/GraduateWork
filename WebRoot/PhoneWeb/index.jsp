...
<body>
			...
			<div id="wrapper" style="overflow: hidden; ">
				<div id="scroller">
					<ul id="thelist">
						<li><p></p>
							<a href="#"><img
								src="upload/img/xctxwlb/20131029/13830151297534.jpg" />
						</a>
						</li>
						<li><p></p>
							<a href="#"><img
								src="upload/img/xctxwlb/20131029/13830151451047.jpg" />
						</a>
						</li>
					</ul>
				</div>
	...
	<div class="main">
		<div>
			<a
				href="../wiying.com/index.php@g=Wap&m=Index&a=content&id=678&token=xctxwlb&wecha_id=o0LVquEUQZAJWEkbfRgk47XcQIUk&loveU=mp.weixin.qq.com">
				<p class="img"
		...
		<div>
			<a
				...
				<p class="text">科室专家</p> </a> <a
				href="index.php@g=Wap&m=Index&a=lists&classid=500&token=xctxwlb&wecha_id=o0LVquEUQZAJWEkbfRgk47XcQIUk&loveU=mp.weixin.qq.com">
				<p class="img"
		...
		<div>
			<a
				href="index.php@g=Wap&m=Index&a=lists&classid=499&token=xctxwlb&wecha_id=o0LVquEUQZAJWEkbfRgk47XcQIUk&loveU=mp.weixin.qq.com">
				<p class="img"
					style="background:url(http://www.wiying.com/upload/img/xctxwlb/20131029/13830140766638.png) center no-repeat; background-size:contain;"></p>
				<p class="text">医院简介</p> </a> <a
				href="index.php@g=Wap&m=Index&a=lists&classid=498&token=xctxwlb&wecha_id=o0LVquEUQZAJWEkbfRgk47XcQIUk&loveU=mp.weixin.qq.com">
				<p class="img"
					style="background:url(http://www.wiying.com/upload/img/xctxwlb/20131029/13830141096885.png) center no-repeat; background-size:contain;"></p>
				<p class="text">医院文化</p> </a>
		</div>
		<div>
			<a
				href="./WebTwo/login.jsp">
				<p class="img"
					style="background:url(http://www.wiying.com/upload/img/xctxwlb/20131029/13830141383823.png) center no-repeat; background-size:contain;"></p>
				<p class="text">服务建议</p> </a> <a
				href="./WebTwo/login.jsp">
				<p class="img"
					style="background:url(http://www.wiying.com/upload/img/xctxwlb/20131029/13830141579551.png) center no-repeat; background-size:contain;"></p>
